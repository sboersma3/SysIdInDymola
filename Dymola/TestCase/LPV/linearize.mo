...
protected
  ...
  Boolean OK1 = LPV.simulateModel(problem=modelNameLin, startTime=Nlin*(counter-1), stopTime=timeStep, outputInterval=samplePeriod, method="dassl");
  // Boolean OK1 = LPV.simulateExtendedModel( problem=modelNameSim, startTime=Nlin*(counter-1), stopTime=timeStep, outputInterval=samplePeriod, method="dassl", resultFile=fileNameSim+String(timeStep));
  // Boolean OK1 = LPV.simulateExtendedModel( problem=modelNameLin, startTime=Nlin*(counter-1), stopTime=timeStep, outputInterval=samplePeriod, method="dassl");
  Boolean OK2 = LPV.importInitial("dsfinal.txt");
