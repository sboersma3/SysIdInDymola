...
model NetworkSimu
  ...
  Modelica.Blocks.Sources.Constant const1(k = 0) annotation (
    Placement(visible = true, transformation(origin={64,214},    extent = {{-6, -6}, {6, 6}}, rotation = 0)));
  Modelica.Blocks.Sources.Constant const2(k = 0)  annotation (
    Placement(visible = true, transformation(origin={86,46},    extent = {{6, -6}, {-6, 6}}, rotation = 0)));
    Modelica.Blocks.Math.Add add(k1=-1)
      annotation (Placement(transformation(extent={{302,320},{322,340}})));
    Modelica.Blocks.Math.Add add1(k1=-1)
      annotation (Placement(transformation(extent={{320,280},{340,300}})));
    Modelica.Blocks.Math.Add add2(k1=-1)
      annotation (Placement(transformation(extent={{282,360},{302,380}})));
    Modelica.Blocks.Interfaces.RealOutput w13
      annotation (Placement(transformation(extent={{340,360},{360,380}})));
    Modelica.Blocks.Interfaces.RealOutput w21
      annotation (Placement(transformation(extent={{340,320},{360,340}})));
    Modelica.Blocks.Interfaces.RealOutput w32
      annotation (Placement(transformation(extent={{356,280},{376,300}})));
    ExcitationGeneration.GenerateMultiSine generateMultiSine2
      annotation (Placement(transformation(extent={{116,240},{136,260}})));
    Modelica.Blocks.Math.Add add3
      annotation (Placement(transformation(extent={{152,230},{162,240}})));
    Modelica.Blocks.Math.Add add4
      annotation (Placement(transformation(extent={{60,186},{50,196}})));
    ExcitationGeneration.GenerateMultiSine generateMultiSine1
      annotation (Placement(transformation(extent={{18,216},{38,236}})));
    ExcitationGeneration.GenerateMultiSine generateMultiSine3
...
equation
  connect(const2.y, vSC_station_dq0_with_control_PLL3.Qref) annotation (
    Line(points={{79.4,46},{0,46},{0,14},{14.5,14},{14.5,13.9}},    color = {0, 0, 127}));
  connect(const1.y, vSC_station_dq0_with_control_PLL1.Qref) annotation (
    Line(points={{70.6,214},{76,214},{76,182},{31.5,182},{31.5,181.9}},    color = {0, 0, 127}));
  connect(const1.y, vSC_station_dq0_with_control_PLL2.Qref) annotation (
    Line(points={{70.6,214},{76,214},{76,180},{140.5,180},{140.5,179.9}},    color = {0, 0, 127}));
  ...
  connect(B5.p, line_4_5.p) annotation (
    ...
    connect(gen2.w2, add.u2) annotation (Line(points={{277,255},{266,255},{266,
            324},{300,324}}, color={0,0,127}));
    connect(gen1.w1, add.u1) annotation (Line(points={{-139,260.8},{-128,260.8},
            {-128,336},{300,336}}, color={0,0,127}));
    connect(add1.u1, gen2.w2) annotation (Line(points={{318,296},{277,296},{277,
            255}}, color={0,0,127}));
    connect(gen3.w3, add1.u2) annotation (Line(points={{78.6,-115},{58,-115},{
            58,-138},{310,-138},{310,284},{318,284}}, color={0,0,127}));
    connect(add2.u2, gen1.w1) annotation (Line(points={{280,364},{-139,364},{
            -139,260.8}}, color={0,0,127}));
    connect(add2.u1, gen3.w3) annotation (Line(points={{280,376},{-168,376},{
            -168,-78},{-22,-78},{-22,-115},{78.6,-115}}, color={0,0,127}));
    connect(add2.y, w13)
      annotation (Line(points={{303,370},{350,370}}, color={0,0,127}));
    connect(add.y, w21)
      annotation (Line(points={{323,330},{350,330}}, color={0,0,127}));
    connect(add1.y, w32)
      annotation (Line(points={{341,290},{366,290}}, color={0,0,127}));
    connect(vdc_control1.Pref, add3.u2) annotation (Line(points={{137,223},{
            146.5,223},{146.5,232},{151,232}}, color={0,0,127}));
    connect(generateMultiSine2.y, add3.u1) annotation (Line(points={{136,250.6},
            {146,250.6},{146,238},{151,238}}, color={0,0,127}));
    connect(add3.y, vSC_station_dq0_with_control_PLL2.Pref) annotation (Line(
          points={{162.5,235},{170,235},{170,216},{142,216},{142,204},{130,204},
            {130,184.5},{140.5,184.5}}, color={0,0,127}));
    connect(add4.u2, const1.y) annotation (Line(points={{61,188},{70.6,188},{
            70.6,214}}, color={0,0,127}));
    connect(generateMultiSine1.y, add4.u1) annotation (Line(points={{38,226.6},
            {48,226.6},{48,202},{66,202},{66,194},{61,194}}, color={0,0,127}));
    connect(add4.y, vSC_station_dq0_with_control_PLL1.Pref) annotation (Line(
          points={{49.5,191},{44,191},{44,186.5},{31.5,186.5}}, color={0,0,127}));
    connect(add5.y, vSC_station_dq0_with_control_PLL3.Pref) annotation (Line(
          points={{23.5,31},{4,31},{4,18.5},{14.5,18.5}}, color={0,0,127}));
    connect(generateMultiSine3.y, add5.u2) annotation (Line(points={{78,24.6},{
            70,24.6},{70,28},{35,28}}, color={0,0,127}));
    connect(add5.u1, vSC_station_dq0_with_control_PLL3.Qref) annotation (Line(
          points={{35,34},{74,34},{74,46},{0,46},{0,14},{14.5,14},{14.5,13.9}},
          color={0,0,127}));
  annotation (
    Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-180,-140},{
              340,380}})),
    Icon(coordinateSystem(extent={{-180,-140},{340,380}},      preserveAspectRatio = false)),
...
model NetworkSysId
  ...
  Modelica.Blocks.Sources.Constant const2(k = 0)  annotation (
    ...
    Modelica.Blocks.Math.Add add5
      annotation (Placement(transformation(extent={{34,26},{24,36}})));
    Modelica.Blocks.Interfaces.RealInput Pref1
      annotation (Placement(transformation(extent={{-6,192},{34,232}})));
    Modelica.Blocks.Interfaces.RealInput Pref2
      annotation (Placement(transformation(extent={{94,236},{134,276}})));
    Modelica.Blocks.Interfaces.RealInput Pref3
      annotation (Placement(transformation(extent={{132,8},{92,48}})));
equation
  connect(const2.y, vSC_station_dq0_with_control_PLL3.Qref) annotation (
    Line(points={{79.4,46},{0,46},{0,14},{14.5,14},{14.5,13.9}},    color = {0, 0, 127}));
  connect(const1.y, vSC_station_dq0_with_control_PLL1.Qref) annotation (
  ...
  connect(B5.p, line_4_5.p) annotation (
    ...
    connect(add5.u1, vSC_station_dq0_with_control_PLL3.Qref) annotation (Line(
          points={{35,34},{74,34},{74,46},{0,46},{0,14},{14.5,14},{14.5,13.9}},
          color={0,0,127}));
    connect(add4.u1, Pref1) annotation (Line(points={{61,194},{66,194},{66,202},
            {42,202},{42,212},{14,212}}, color={0,0,127}));
    connect(add3.u1, Pref2) annotation (Line(points={{151,238},{148,238},{148,
            240},{142,240},{142,256},{114,256}}, color={0,0,127}));
    connect(add5.u2, Pref3)
      annotation (Line(points={{35,28},{112,28}}, color={0,0,127}));
  annotation (
    Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-180,-140},{
              340,380}})),
    Icon(coordinateSystem(extent={{-180,-140},{340,380}},      preserveAspectRatio = false)),
