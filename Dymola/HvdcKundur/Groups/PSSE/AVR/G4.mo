...
equation
  ...
  connect(gENSAL.PMECH, gENSAL.PMECH0) annotation (Line(points={{0,9},{2,9},{2,
          14},{-8,14},{-8,32},{50,32},{50,9},{46,9}},           color={0,0,127}));
  connect(eSDC1A.EFD, gENSAL.EFD) annotation (Line(points={{0.8,-8.22222},{0.8,
          -9},{0,-9},{0,-9}},            color={0,0,127}));
  ...
  connect(eSDC1A.VOEL, eSDC1A.VUEL) annotation (Line(points={{-21.6,-16},{-44,
          -16},{-44,-16},{-26.4,-16}},                  color={0,0,127}));
  connect(eSDC1A.VOTHSG, eSDC1A.VUEL) annotation (Line(points={{-32,-4.72222},{
          -44,-4.72222},{-44,-16},{-26.4,-16}},        color={0,0,127}));
  connect(gENSAL.ETERM, eSDC1A.ECOMP) annotation (Line(points={{46,-5.4},{52,
          -5.4},{52,-24},{-38,-24},{-38,-8.22222},{-32,-8.22222}},
                                                              color={0,0,127}));
  annotation (
