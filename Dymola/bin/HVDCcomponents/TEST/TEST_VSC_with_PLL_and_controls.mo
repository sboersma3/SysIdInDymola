...
model TEST_VSC_with_PLL_and_controls
  ...
  HVDCcomponents.VSC_station_dq0_with_control_PLL vSC_station_dq0_with_control_PLL(Lr = 0.05, Rr = 0.5, tr = 0.003, wg = 314)  annotation(
    Placement(visible = true, transformation(origin = {-8, 8}, extent = {{-20, -13}, {40, 12}}, rotation = 0)));
equation
  ...
  connect(capacitor1.p, vSC_station_dq0_with_control_PLL.pin_p) annotation(
    Line(points = {{-62, 20}, {-38, 20}, {-38, 6}, {-20, 6}, {-20, 6}}, color = {0, 0, 255}));
  connect(capacitor1.n, vSC_station_dq0_with_control_PLL.pin_n) annotation(
    Line(points = {{-62, 6}, {-62, 6}, {-62, 2}, {-18, 2}, {-18, 2}}, color = {0, 0, 255}));
  connect(vSC_station_dq0_with_control_PLL.p, pQ_sensor1.p) annotation(
    Line(points = {{4, 8}, {22, 8}, {22, 2}, {50, 2}, {50, 2}}, color = {0, 0, 255}));
  connect(vSC_station_dq0_with_control_PLL.Qref, step2.y) annotation(
    Line(points = {{-20, 12}, {-28, 12}, {-28, -20}, {-40, -20}, {-40, -18}}, color = {0, 0, 127}));
  connect(vdc_PI_control1.Pref, vSC_station_dq0_with_control_PLL.Pref) annotation(
    Line(points = {{-30, 60}, {-28, 60}, {-28, 16}, {-20, 16}, {-20, 16}}, color = {0, 0, 127}));
  annotation(
    Diagram(graphics = {Line(origin = {0, 8}, points = {{0, 0}})}, coordinateSystem(initialScale = 0.1)));

end TEST_VSC_with_PLL_and_controls;
