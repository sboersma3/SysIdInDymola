...
model TEST_VSC_DCcable_with_all_controls
  ...
  HVDCcomponents.DC_cable dC_cable1(Vinit = 640E3, length = 300) annotation(
    Placement(visible = true, transformation(origin = {-31, -5}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  Modelica.Electrical.Analog.Basic.Ground ground1 annotation(
    Placement(visible = true, transformation(origin = {-63, -11}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
equation
  connect(capacitor1.n, ground1.p) annotation(
    Line(points = {{-62, 6}, {-62, 6}, {-62, -4}, {-62, -4}}, color = {0, 0, 255}));
  connect(dC_cable1.pin_n1, vSC_station_dq0_with_control1.pin_n) annotation(
    Line(points = {{-24, -8}, {-14, -8}, {-14, -4}, {-2, -4}, {-2, -4}}, color = {0, 0, 255}));
  connect(dC_cable1.pin_p1, vSC_station_dq0_with_control1.pin_p) annotation(
    Line(points = {{-24, -2}, {-16, -2}, {-16, 0}, {-4, 0}, {-4, 0}}, color = {0, 0, 255}));
  connect(capacitor1.n, dC_cable1.pin_n) annotation(
    Line(points = {{-62, 6}, {-52, 6}, {-52, -8}, {-38, -8}, {-38, -8}}, color = {0, 0, 255}));
  connect(capacitor1.p, dC_cable1.pin_p) annotation(
    Line(points = {{-62, 20}, {-42, 20}, {-42, -2}, {-38, -2}, {-38, -2}}, color = {0, 0, 255}));
  connect(vSC_station_dq0_with_control1.Qref, step2.y) annotation(
    Line(points = {{-4, 6}, {-28, 6}, {-28, 33}, {-5.5, 33}}, color = {0, 0, 127}));
  connect(pQ_sensor1.p, vSC_station_dq0_with_control1.p) annotation(
    Line(points = {{50, 2}, {19, 2}}, color = {0, 0, 255}));
  connect(vdc_PI_control1.Pref, vSC_station_dq0_with_control1.Pref) annotation(
    Line(points = {{-31, 59}, {-24, 59}, {-24, 11}, {-4, 11}}, color = {0, 0, 127}));
...
end TEST_VSC_DCcable_with_all_controls;
