...
model TEST_3VSCs_DCcable_with_PLL_and_all_controls
  ...
  HVDCcomponents.VSC_station_dq0_with_control_PLL_bis vSC_station_dq0_with_control_PLL_bis(Ib = 4350, Vb = 230E3)  annotation(
    Placement(visible = true, transformation(origin = {-174, 4}, extent = {{40, -13}, {-20, 12}}, rotation = 0)));
  VSC_station_dq0_with_control_PLL_bis vSC_station_dq0_with_control_PLL_bis1(Ib = 4350, Vb = 230E3)  annotation(
    Placement(visible = true, transformation(origin = {10, 6}, extent = {{-20, -13}, {40, 12}}, rotation = 0)));
  HVDCcomponents.VSC_station_dq0_with_control_PLL_bis vSC_station_dq0_with_control_PLL_bis2(Ib = 4350, Vb = 230E3)  annotation(
