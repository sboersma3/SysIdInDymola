...
model GroupBus8
  ...
  OpenIPSL.Electrical.Machines.PSAT.Order6 Syn4(
    ...
    ra=0.0041) annotation (Placement(transformation(
        ...
        rotation=0,
        origin={53,1})));
  OpenIPSL.Interfaces.PwPin pwPin annotation (Placement(transformation(extent={{100,-8},
            {120,12}}),         iconTransformation(extent={{100,-8},{120,12}})));
equation
  connect(aVR3TypeII2.vf, Syn4.vf) annotation (Line(points={{10,13},{18.5,13},{
          18.5,9.5},{32.6,9.5}}, color={0,0,127}));
  connect(Syn4.v, aVR3TypeII2.v) annotation (Line(points={{71.7,6.1},{96,6.1},{
          96,-34},{-38,-34},{-38,0.4}}, color={0,0,127}));
  connect(Syn4.p, pwPin) annotation (Line(points={{70,1},{101.85,1},{101.85,2},
          {110,2}},color={0,0,255}));
  connect(Syn4.pm0, Syn4.pm) annotation (Line(points={{39.4,-17.7},{39.4,-26},{
          16,-26},{16,-7.5},{32.6,-7.5}}, color={0,0,127}));
  connect(Syn4.vf0, aVR3TypeII2.vf0) annotation (Line(points={{39.4,19.7},{39.4,
          38},{10,38},{10,-24},{-14,-24},{-14,-12.2}}, color={0,0,127}));
  connect(aVR3TypeII2.vref0, aVR3TypeII2.vref) annotation (Line(points={{-14,
          38.2},{-14,62},{-58,62},{-58,25.6},{-38,25.6}},          color={0,0,
          127}));
  annotation (
