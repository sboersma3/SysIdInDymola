...
model BusExt
  ...
  Modelica.Blocks.Interfaces.RealOutput Voltage
    annotation (Placement(transformation(extent={{148,122},{168,142}})));
  Modelica.Blocks.Interfaces.RealOutput Vi
    annotation (Placement(transformation(extent={{148,102},{168,122}})));
  ...
  Modelica.Blocks.Interfaces.RealOutput Angle
    annotation (Placement(transformation(extent={{148,142},{168,162}})));
protected
