...
model vdc_control
  ...
  HVDCcomponents.vdc_controls.vdc_IP_control vdc_IP_control1(Cdc = Cdc, Ksi = Ksi, tr = tr) annotation(
    Placement(visible = true, transformation(origin = {-1, 11}, extent = {{-15, -15}, {15, 15}}, rotation = 0)));
  HVDCcomponents.vdc_controls.vdc_PI_control vdc_PI_control1(Cdc = Cdc, Ksi = Ksi, tr = tr) annotation(
    Placement(visible = true, transformation(origin = {-1, 73}, extent = {{-15, -15}, {15, 15}}, rotation = 0)));
  ...
  HVDCcomponents.vdc_controls.vdc_PI_control_with_filter vdc_PI_control_with_filter1(Cdc = Cdc, Ksi = Ksi, tr = tr) annotation(
...
vdc_PI_control_with_filter1.vdcref = 0;
  elseif controlType == "IP+filter" then
