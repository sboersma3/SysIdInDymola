...
model VSC_station_dq0_with_control
  ...
  HVDCcomponents.VSC_station_components.Idqref_calc_VSC idqref_calc_VSC1 annotation (
    Placement(visible = true, transformation(origin = {-106, 62}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  HVDCcomponents.VSC_station_components.Inner_control_VSC_blocks inner_control_VSC_blocks1(Lr = Lr, Rr = Rr, tr = tr, wg = wg) annotation (
    Placement(visible = true, transformation(origin = {64, 6}, extent = {{-10, -20}, {20, 10}}, rotation = 0)));
...
equation
  ...
  connect(vq.v, inner_control_VSC_blocks1.vgq) annotation (
    Line(points={{198,-56},{200,-56},{200,-86},{46,-86},{46,-2},{52.3,-2},{52.3,
          -1.5}},                                                                                color = {0, 0, 127}));
  connect(vd.v, inner_control_VSC_blocks1.vgd) annotation (
    Line(points={{186,64},{188,64},{188,96},{34,96},{34,2},{52.3,2},{52.3,2.5}},          color = {0, 0, 127}));
  ...
  connect(currentSensor_iq.i, inner_control_VSC_blocks1.igq) annotation (
    Line(points={{134,-83},{38,-83},{38,8},{52.3,8},{52.3,7.9}},      color = {0, 0, 127}));
  connect(currentSensor_id.i, inner_control_VSC_blocks1.igd) annotation (
    Line(points={{102,91},{38,91},{38,12},{52.3,12},{52.3,12.1}},      color = {0, 0, 127}));
  connect(inner_control_VSC_blocks1.vmd, modulated_d_voltage.v) annotation (
    Line(points={{75.6,7.8},{80,7.8},{80,30},{68,30},{68,44},{54,44},{54,54},{
          50,54},{50,70},{52,70}},                                                                                    color = {0, 0, 127}));
  connect(inner_control_VSC_blocks1.vmq, modulated_q_voltage.v) annotation (
    Line(points={{75.6,-0.8},{80,-0.8},{80,-34},{54,-34},{54,-56},{64,-56},{64,
          -56}},                                                                             color = {0, 0, 127}));
  connect(idqref_calc_VSC1.igqref, inner_control_VSC_blocks1.igqref) annotation (
    Line(points={{-94.4,57.8},{-50,57.8},{-50,48},{52,48},{52,32},{66,32},{66,
          17.7},{65.5,17.7}},                                                                          color = {0, 0, 127}));
  connect(idqref_calc_VSC1.igdref, inner_control_VSC_blocks1.igdref) annotation (
    Line(points={{-94.4,66},{-44,66},{-44,44},{48,44},{48,30},{60,30},{60,17.7},
          {60.3,17.7}},                                                                                color = {0, 0, 127}));
  connect(vd.v, idqref_calc_VSC1.vgd) annotation (
    Line(points = {{186, 64}, {186, 64}, {186, 108}, {-106, 108}, {-106, 74}, {-106, 74}}, color = {0, 0, 127}));
  connect(idqref_calc_VSC1.Pref, Pref) annotation (
    Line(points={{-118,66},{-178,66},{-178,84},{-215,84},{-215,83}},            color = {0, 0, 127}));
  connect(idqref_calc_VSC1.Qref, Qref) annotation (
    Line(points={{-118,58},{-206,58},{-206,55},{-215,55}},          color = {0, 0, 127}));
