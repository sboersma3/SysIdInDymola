...
model Inner_control_VSC_blocks_PLL
parameter Real Lr;
parameter Real Rr;
parameter Real tr;
parameter Real Pref;
...
Modelica.Blocks.Math.Add3 add32(k1 = +1, k3 = +1) annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput wpll annotation(
    Placement(visible = true, transformation(origin = {-117, -61}, extent = {{-17, -17}, {17, 17}}, rotation = 0), iconTransformation(origin = {-117, -61}, extent = {{-17, -17}, {17, 17}}, rotation = 0)));
...
end Inner_control_VSC_blocks_PLL;
