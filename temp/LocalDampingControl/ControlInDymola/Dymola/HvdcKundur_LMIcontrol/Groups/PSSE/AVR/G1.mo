...
equation
  connect(g1.PMECH, g1.PMECH0) annotation (Line(points={{-6,9},{-6,9},{-12,9},{
          -12,10},{-12,26},{44,26},{44,9},{40,9}},          color={0,0,127}));
  connect(g1.p, pwPin)
    annotation (Line(points={{38,0},{38,0},{70,0}}, color={0,0,255}));
  connect(sEXS.EFD, g1.EFD) annotation (Line(points={{-7.15,-8},{-7.15,-9},{-6,
          -9}}, color={0,0,127}));
  ...
  connect(g1.ETERM, sEXS.ECOMP) annotation (Line(points={{40,-5.4},{50,-5.4},{
          50,-30},{-50,-30},{-50,-8},{-42,-8}},
                                        color={0,0,127}));
  connect(sEXS.VOTHSG, u) annotation (Line(points={{-42,-3.5},{-44,-3.5},{-44,
