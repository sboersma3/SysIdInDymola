...
block ObserverTemplate
  ...
  extends Modelica_LinearSystems2.Controller.Interfaces.PartialSampledBlock;
...
// y_start-plantModelSystem2.C*L2*observerStateSpace.y_start
  ...
  Modelica_LinearSystems2.Controller.StateSpace observerStateSpace(
    x_start=x_start,
...
initial equation
  ...
  elseif init == Modelica_LinearSystems2.Controller.Types.Init.InitialOutput
       then
