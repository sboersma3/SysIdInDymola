...
equation
  ...
  Documentation(info = "<html><head></head><body>2-level VSC converter station model as presented in&nbsp;<span class=\"fontstyle0\">Samy Akkari. Control of a multi-terminal HVDC (MTDC) system and study of the interactions&nbsp;between the MTDC and the AC grids. Université Paris-Saclay, 2016.</span>&nbsp;&nbsp;<br style=\"orphans: 2; text-align: -webkit-auto; widows: 2;\">
