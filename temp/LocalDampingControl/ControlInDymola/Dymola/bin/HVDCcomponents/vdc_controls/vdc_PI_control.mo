...
model vdc_PI_control
  ...
  Modelica.Blocks.Continuous.Integrator integrator1(k = (1 / tr) ^ 2 * Cdc, y(start = 0)) annotation (
...
equation
  connect(add1.u1, product1.y) annotation (
    Line(points = {{-62, 12}, {-98, 12}, {-98, 12}, {-98, 12}}, color = {0, 0, 127}));
