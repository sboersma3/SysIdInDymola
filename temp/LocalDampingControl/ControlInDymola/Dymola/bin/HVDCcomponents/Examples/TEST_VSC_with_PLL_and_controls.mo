...
model TEST_VSC_with_PLL_and_controls
  ...
  Modelica.Blocks.Sources.Step step2(height = 200E6, startTime = 0) annotation (
  ...
  HVDCcomponents.VSC_station_dq0_with_control_PLL vSC_station_dq0_with_control_PLL_bis1(Lr = 0.05, P_ref = 700E6, Q_ref = -200E6, Rr = 0.5, Vgd = 400E3, tr = 0.003)  annotation (
