...
equation
  connect(g2.PMECH, g2.PMECH0) annotation (Line(points={{2,9},{-2,9},{-2,32},{
          52,32},{52,9},{48,9}},          color={0,0,127}));
  connect(g2.p, pwPin)
  ...
  connect(eSDC1A.VOEL, eSDC1A.VUEL) annotation (Line(points={{-26.95,-18},{-42,
          -18},{-42,-18},{-32.05,-18}},                 color={0,0,127}));
  connect(eSDC1A.VOTHSG, eSDC1A.VUEL) annotation (Line(points={{-38,-3.5},{-42,
          -3.5},{-42,-18},{-32.05,-18}},               color={0,0,127}));
