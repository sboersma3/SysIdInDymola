...
var_e_i=thhati.noisevariance;   %var_e;

Pi=thhati.covariancematrix;
...
Fui=ss(Afu,Bfu,Cfu,Dfu,1);
Fui=ssbal(Fui);

Ti=Fui*ss(tf([1 0 0 0 0],denGi,1));
...
figure(4)
loglog(wbis,vecradm,'k:',wbis,vecrw,'k',wbis,vecrwi,'b')
xlabel('w')
