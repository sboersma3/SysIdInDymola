...
%[wcperf2]=worstcaseperformance(0,zn,zd,thetai,inv(Pthetath)/chi,ccid,1,0,1,0,1);
vecwc=[vecwc,wcperf];
%vecwc2=[vecwc2,wcperf2];

end;

vecerror=[vecerror, max((vecwc-template)./vecwc)];

% figure(3)
% loglog(wbis,template,'k:',wbis,vecwc,'b',wbis,Smod,'k-.')
% xlabel('w')
